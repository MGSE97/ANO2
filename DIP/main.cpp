...
vector<float> HOG(Mat& src, Mat* dst, Size block, Size cell, int nBins = 9, bool dominant = false);
...
vector<float> HOG(Mat& src, Mat* dst, Size block, Size cell, int nBins, bool dominant)
{
